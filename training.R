...
inatall.packages("readr")
install.packages("dplyr")
install.packages("tidyr")
install.packages("ggplot2")
install.packages("fastDumies")
...
file_path<-"C:/Users/admin/Downloads/Hospital+Patient+Records/patients.csv"
...
data_cleaned<-data%>%replace_na(list(YearsExperiance = median
                                    (data$YearsExperiance,na.rm = TRUE),
...
plot(airquality$Ozone,xlab='ozone',ylab = 'no of instances',main = 'ozone level in the city',col='green',pch=16)

hist(airquality$Solar.R,col = 'yellow')


hist(airquality$Solar.R,main = 'solar radiation',xlab ='solar rad',col='red')
...
text(h$mids,h$count,labels=h$count,adj=c(0.5,-0.5))
 
hist(temperature,main = 'hari',xlab = 'simba',xlim = c(50,100),col = 'green',border = 'black',breaks = c(55,60,70,75,80,100))

hist(temperature,col="green")
...
salary_data<-read.csv("C:/Users/admin/Downloads/Hospital+Patient+Records/patients.csv")
